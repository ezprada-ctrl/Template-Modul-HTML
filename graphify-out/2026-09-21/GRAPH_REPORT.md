...
## Summary
- 1065 nodes · 1874 edges · 80 communities (64 shown, 16 thin omitted)
...
Cohesion: 0.06
Nodes (64): 14 Jenis Blok Konten, Preview & Export (Tahap 5), Susun Modul (Tahap 2), art_entry(), _blok_heading(), build_nav(), _caption_html(), clamp_brightness() (+56 more)
...
Cohesion: 0.08
Nodes (25): demoBoothJalan(), remove(), BlockFields(), blockSummary(), detectPngTransparency(), FieldStyle, GridCellPreview(), ImageUploadField() (+17 more)

### Community 10 - "App.tsx"
Cohesion: 0.11
Nodes (20): draftExists(), App(), handleCreateProject(), handleImportJson(), hentikanDemo(), mulaiDemo(), onKey(), AutosaveIndicator() (+12 more)
...
### Community 12 - "api.ts"
Cohesion: 0.14
Nodes (18): ArticulateInfo, CocreationSection, CocreationSlide, deleteArticulate(), extractPptx(), PeringatanDetail, r2Tersedia(), readArticulateEntry() (+10 more)
...
Cohesion: 0.23
Nodes (10): History, DemoCaptionEditor(), Props, Props, Props, collectTypes(), DEMO_STEPS, DemoStep (+2 more)
...
Cohesion: 0.33
Nodes (4): Props, SlideBank(), addToCanvas(), DraftSlide

### Community 22 - "Render the current NAV item into the viewport"
Cohesion: 0.16
Nodes (23): Get or create the shared Web Audio context, Schedule a single oscillator tone, Record a quiz option selection, Inject/play per-slide voiceover audio, Section Quiz Checkpoint, Check whether a section's quiz has been passed, Play the correct-answer chime, Play the quiz-failed tone (+15 more)
...
### Community 24 - "Canvas"
Cohesion: 0.20
Nodes (16): Canvas(), addBlankSlide(), addBundle(), addSection(), bukaSlideNomor(), bundlesFor(), gulirKeBaris(), onDragEnd() (+8 more)
...
Cohesion: 0.14
Nodes (21): copyDraft(), deleteDraft(), generateHtml(), payloadFor(), renameDraft(), saveDraft(), PreviewExport(), catatJudulExport() (+13 more)

### Community 33 - "types.ts"
Cohesion: 0.17
Nodes (18): Props, kebijakanKuisSection(), kebijakanMentah(), modeKuisSection(), applyBlockText(), BlockColor, changeBlockType(), DEFAULT_QUIZ_POLICY (+10 more)
...
Cohesion: 0.18
Nodes (9): ambilDaftar(), BlockEditor(), add(), changeType(), toggleCollapse(), langgananBlokAktif(), sarangRapiNyala(), setSarangRapi() (+1 more)

### Community 36 - "Canvas.tsx"
Cohesion: 0.20
Nodes (7): uploadMediaToStorage(), VideoUploadField(), Props, SlideAudioField(), SlideRow(), Section, Slide
...
Cohesion: 0.36
Nodes (8): SCORM API Wrapper, Load learner progress state from SCORM or localStorage, SCORM LMSCommit/Commit wrapper, Walk window/parent chain to find SCORM API, SCORM LMSFinish/Terminate wrapper, Resolve SCORM API via window or opener, SCORM LMSGetValue/GetValue wrapper, Initialize SCORM session
...
### Community 71 - "PreviewExport.tsx"
Cohesion: 0.19
Nodes (16): fetchArticulateZip(), generateHtmlForZip(), blobKeDataUri(), HasilSemat, namaAset(), sematkanGambarDataUri(), urlGambar(), articulateBlocks() (+8 more)
...
### Community 74 - "Record a content-interaction event (accordion/tabs/modal/flow)"
Cohesion: 0.25
...
### Community 78 - "ccCocreation"
Cohesion: 0.67
Nodes (3): ccCocreation(), bukaCocreation(), bukaCocreationSemua()

### Community 79 - "Alat "Cek Rekam Aktivitas""
Cohesion: 0.67
...
## Knowledge Gaps
- **205 isolated node(s):** `EntriBlok`, `VIDEO_CONTOH`, `DEMO_ABORT`, `DEMO_IDLE_RESUME_MS`, `Panggung` (+200 more)
...
- **Why does `react` connect `App.tsx` to `types.ts`, `Canvas.tsx`, `EmojiPicker.tsx`, `PreviewExport.tsx`, `PaketExportDialog.tsx`, `BlockEditor.tsx`, `CoverForm.tsx`, `CommandCenter.tsx`, `ModuleData`, `BlockPreview.tsx`, `SlideBank.tsx`, `GraphicStyleSelect.tsx`, `plugins`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `CommandCenter()` connect `CommandCenter` to `ccPost`, `App.tsx`, `CommandCenter.tsx`, `ccCocreation`?**
...
- **What connects `EntriBlok`, `VIDEO_CONTOH`, `DEMO_ABORT` to the rest of the system?**
