...
### Community 8 - "extractBlockText"
Cohesion: 0.40
Nodes (5): remove(), blockSummary(), GridCellPreview(), extractBlockText(), isBlockEmpty()
...
Cohesion: 0.13
Nodes (13): uploadImageToStorage(), uploadMediaToStorage(), BlockFields(), detectPngTransparency(), FieldStyle, ImageUploadField(), ModalFields(), pendengarBlokAktif (+5 more)

### Community 38 - "BlockEditor"
Cohesion: 0.22
Nodes (8): BlockEditor(), add(), changeType(), toggleCollapse(), langgananBlokAktif(), applyBlockText(), changeBlockType(), newBlock()

### Community 40 - "deleteArticulate"
Cohesion: 0.67
Nodes (3): deleteArticulate(), ArticulateFields(), pilihFile()
...
Cohesion: 0.06
Nodes (49): checkTrackingConfig(), listDrafts(), loadDraft(), App(), handleCreateProject(), handleOpenExistingDraft(), AutosaveIndicator(), History (+41 more)

### Community 49 - "SlidePreview"
Cohesion: 0.53
