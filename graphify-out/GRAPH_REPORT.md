...
## Corpus Check
- 63 files · ~246,752 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1078 nodes · 1906 edges · 73 communities (56 shown, 17 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 183 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `29290315`
...
Cohesion: 0.12
Nodes (25): listDraftsRingkas(), bacaLogoPng(), inp, KONSEP_INFO, LogoBaca, PaketExportDialog(), tambahBerkas(), tambahLogo() (+17 more)

### Community 9 - "BlockEditor.tsx"
Cohesion: 0.06
Nodes (33): demoBoothJalan(), ambilDaftar(), BlockEditor(), add(), remove(), toggleCollapse(), BlockFields(), blockSummary() (+25 more)
...
### Community 12 - "api.ts"
Cohesion: 0.11
Nodes (24): ArticulateInfo, CocreationNote, CocreationSection, CocreationSlide, deleteArticulate(), DraftRingkas, extractPptx(), generateHtmlForZip() (+16 more)

### Community 13 - "CommandCenter.tsx"
Cohesion: 0.12
Nodes (17): ActivityLearner, ActivityModule, ActivitySession, CocreationModule, RincianSlide, CatatanSlidePeserta, CocreationPesertaView(), perPeserta() (+9 more)
...
### Community 27 - "PreviewExport"
Cohesion: 0.18
Nodes (17): copyDraft(), generateHtml(), saveDraft(), PreviewExport(), catatJudulExport(), doCopy(), doDelete(), doExport() (+9 more)
...
Cohesion: 0.13
Nodes (21): ccCocreation(), ccRawRows(), ccRincian(), barisCatatan(), CommandCenter(), ambilRincian(), bukaCocreation(), bukaCocreationSemua() (+13 more)

### Community 32 - "PreviewExport.tsx"
Cohesion: 0.17
Nodes (17): deleteDraft(), fetchArticulateZip(), renameDraft(), blobKeDataUri(), HasilSemat, namaAset(), sematkanGambarDataUri(), urlGambar() (+9 more)

### Community 33 - "types.ts"
Cohesion: 0.20
Nodes (15): Props, kebijakanKuisSection(), kebijakanMentah(), modeKuisSection(), BlockColor, DEFAULT_QUIZ_POLICY, KcQuestion, KEBIJAKAN_GERBANG (+7 more)
...
### Community 35 - "Canvas.tsx"
Cohesion: 0.15
Nodes (11): uploadMediaToStorage(), VideoUploadField(), Props, SlideAudioField(), SlideRow(), Props, SlidePreview(), bawaPopupKeLayar() (+3 more)

### Community 36 - "SlideBank.tsx"
Cohesion: 0.17
Nodes (12): changeType(), addBlankSlide(), Props, SlideBank(), addToCanvas(), applyBlockText(), changeBlockType(), DraftSlide (+4 more)
...
### Community 38 - "react"
Cohesion: 0.29
Nodes (4): EmojiPicker(), Props, EMOJI_CATEGORIES, react
...
Cohesion: 0.24
Nodes (14): listDrafts(), loadDraft(), handleOpenExistingDraft(), NewProjectModal(), handleFile(), openExistingMode(), pickDraft(), jalankan() (+6 more)
...
## Knowledge Gaps
- **205 isolated node(s):** `WADAH_TABEL`, `TH_ATAS`, `SEL_NAMA`, `TH_NAMA`, `CatatanSlidePeserta` (+200 more)
...
- **Why does `react` connect `react` to `PreviewExport.tsx`, `types.ts`, `Canvas.tsx`, `SlideBank.tsx`, `PaketExportDialog.tsx`, `BlockEditor.tsx`, `App.tsx`, `CoverForm.tsx`, `CommandCenter.tsx`, `ModuleData`, `BlockPreview.tsx`, `GraphicStyleSelect.tsx`, `plugins`?**
...
- **What connects `WADAH_TABEL`, `TH_ATAS`, `SEL_NAMA` to the rest of the system?**
